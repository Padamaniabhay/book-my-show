    ...
    return(
        ...
        <div className="container mx-auto px-4">
            <div className="w-full lg:flex lg:flex-row-reverse">
                ...
                <h2 className="text-2xl font-bold">Plays In Rajkot</h2>
                <div className="flex flex-wrap">
                <div className="w-1/2  md:w-1/3 mb-3 lg:w-1/4">
                    <Poster 
                    ...
                    subtitle="Watch on BookMyShow English ₹ 199"/>
                </div>
                <div className="w-1/2  md:w-1/3 mb-3 lg:w-1/4">
                    <Poster 
                    src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-RnJpLCAxNSBPY3Q%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00315140-nugukwkqzq-portrait.jpg"
                ...
                <div className="lg:w-1/4">
                    ...
                    <div>
                        ...
                        <PlaysFilter title="Language" tags={["Gujarati","English","Hindi"]}/>
