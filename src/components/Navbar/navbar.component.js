    ...
    return(
        ...
        <div className="text-white flex items-center justify-between">
            <div>
                ...
                <span className="text-gray-400 text-xs flex items-center">Rajkot<BiChevronRight/></span>
            </div>
            <div>
               <div className="w-7 h-7"> <BiSearch className="w-full h-full"/></div>
            </div>
        </div>
        </>
    )
...
const Navbar=()=>{
    return(
        ...
        <nav className="bg-navCol-700 px-4 py-2">
            ...
            <div className="hidden lg:hidden md:flex">{  //all hidden
                //Tablet screen
                <NavMd/>
            }</div>
